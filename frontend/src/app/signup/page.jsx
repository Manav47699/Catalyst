...
import { User, Lock, Phone, Calendar, Users, MapPin, CheckCircle } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl border-2 border-green-200 overflow-hidden">
          ...
          <div className="p-8 space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-3 border-2 border-green-200 rounded-xl focus:ring-2 focus:ring-green-400 focus:border-green-400 focus:outline-none transition-all text-gray-900 appearance-none"
                >
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                City {shareLocation && <span className="text-red-500">*</span>}
              </label>
              <div className="relative">
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 w-5 h-5 text-green-600 border-green-300 rounded focus:ring-green-400"
                />
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    Sharing your location allows other learners with similar instrest see your city
                  </p>
                </div>
              </label>
            </div>
